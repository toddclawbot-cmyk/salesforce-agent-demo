"""
Sage — Salesforce Developer Agent Demo
...
def chat():
    """Process a message through Sage."""
...
def architecture():
    ...
    arch = {
        "title": "Sage — Portable AI Agent Architecture",
        "subtitle": "The employee brings their agent. The company provides the tools.",
        "layers": [
            {
                "name": "The Employee's Agent (Sage)",
                "color": "#6366f1",
                "components": [
...
<head>
    ...
    <title>Sage — AI Agent Demo</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .message.sage .message-bubble code {
        ...
        .message.sage .message-bubble strong {
            color: var(--cyan);
        }
        
        .message.sage .message-bubble em {
            color: var(--text-secondary);
            font-style: italic;
        }
...
<body>
        ...
        <div class="main-grid">
            ...
            <div class="panel chat-panel">
                <div class="panel-header">
                    ...
                    <div class="panel-title">Chat with Sage</div>
                </div>
                
                <div class="chat-messages" id="chatMessages">
                    <div class="message sage">
                        <div class="message-bubble">
                            Hello! I'm <strong>Sage</strong>, your Salesforce development agent. 🧙‍♂️<br><br>
                ...
                <div class="chat-input-area">
                    <input type="text" class="chat-input" id="chatInput" placeholder="Ask Sage anything..." onkeypress="handleKeyPress(event)">
    ...
    <script>
        ...
        async function sendMessage() {
            ...
            // Show loading
            const loadingDiv = addMessage('sage', '<div class="loading"><div class="loading-dots"><span></span><span></span><span></span></div> Thinking...</div>');
            ...
            try {
                ...
                loadingDiv.remove();
                addMessage('sage', 'Sorry, I encountered an error. Please try again.');
            }
...
if __name__ == "__main__":
    print("🚀 Starting Sage — AI Agent Demo")
